...
## Features
• AI-powered insight engine that understands Solana tokens, NFTs, and liquidity changes  
...
Phase 2: On-chain data connection  
Phase 3: AI model deployment  
Phase 4: Public beta and developer API
